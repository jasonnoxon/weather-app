$(document).ready( function() {
  ...
  $.each (weather, function(index, forecast) {
    let $highLowH3 = $("<h3/>", { text: forecast.high + "/" + forecast.low });
    let $weatherImg = $("<img/>", { src: forecast.imgUrl })
    let $dateH3 = $("<h3/>", { text: forecast.date } );
